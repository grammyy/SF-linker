    ...
    for link,callback in pairs(links) do
        ...
        http.get(link.."?time="..timer.realtime(),function(data)
            ...
            if (!func or error) and CLIENT then
                printConsole(Color(255,0,0),"[Failed: "..SERVER==true and "SERVER" or "CLIENT".."]",Color(255,255,255),": "..link.." ; ",Color(255,0,0),func,Color(255,255,255)," ; ",error)
            else
                func()
                ...
                printConsole(Color(0,255,0),"[Loaded: "..SERVER==true and "SERVER" or "CLIENT".."]",Color(255,255,255),": "..link)
            end
        end)
    end
end
